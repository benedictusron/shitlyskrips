 ...
 * @author JarkomOye
 */
public class SoSimBer implements RoutingDecisionEngine {
    ...
    public SoSimBer(Settings s) {

    }
    
    public SoSimBer(SoSimBer proto) {
...
//            System.out.println(this.euclidean);
        ...
        SoSimBer otherSoSim = (SoSimBer) otherRouter.getDecisionEngine();
    ...
    public Double hitungEuclideanSim(DTNHost host, DTNHost peer) {
        ...
        SoSimBer otherSoSim = (SoSimBer) otherDe.getDecisionEngine();
